...
$c_date = date('Y-m-d');
$sql = 'SELECT * FROM businfo WHERE departure = ? AND arrival = ? AND departure_date = ? AND departure_time > ?';
				...
				<div class="businfo-res" id="businfo-seats">
					<div class="sub-businfo-res py-4 px-4">
						...
						<div class="price row py-2 px-4 col-lg-3">
							...
							<div class="row col-lg-12">
								<button type="button" class="view-seats" onclick="seats(this)" id="<?= $businfo->id?>">view-seat</button>
							</div>
						</div>
					</div>
				</div>
