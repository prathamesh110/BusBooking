...
<body id=sucess-fetch>
<?php include('includes/header.php');?>
<section class="full-sec">
  <div class="container-fluid">
   <div class="row" id=sucess-fetch>
     ...
     <div class="sec-search  col-12  col-md-12 col-lg-12">
       <form method="post" action="tourbook1.php" class="was-validated form_data" id="frmsearch">
         <div class="top-search-bg">
           <div class="form-search">
           	  <div class="form-group  px-2 ">
                 <input type="search" class="form-control form_data" id="source" value="<?=$_POST['source']?>" placeholder="Source" name="source" required>
              ...
              <div class="search-busses  px-2">
                <button type="button" class="btn btn-primary" onclick="loadDoc()" id="search-b">Search Trek</button>
              </div>
            </div>
          </div>
        </form>
        <div class="res-search-bg">
          <div class="bus-res" id="bus-res">
            <?php include('includes/tour_res1.php');?>
          </div>
        </div>
     </div>
    </div>
...
<script src="js/toursearchajax.js"></script>
<script src="js/Tsucessajax.js"></script>
